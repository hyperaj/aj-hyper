...
from AM.utils import get_readable_time
from AM.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgQAAxkBAAL5_WYz5OO5s7wC7UmQTYTTX7JwgaFlAAJzCgACjBYxUALCOWgSNn4CHgQ")
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgQAAxkBAAL6AAFmM-Uk9r2dGev4872xdHAa5FLgGAACTgoAAulTgFHJHLe-724t4x4E")
    await message.reply_text(
